...
const Question = [
  {
    "semester": "Semester 1",
    "subject": "BUSINESS COMMUNICATION (ENG F1001)",
    "questions": [
      {
        "question": "Define Operations Research. Mention its importance in business decision-making.",
        "marks": 10
      },
      {
        "question": "List and explain any four characteristics of the Operations Research approach.",
        "marks": 10
      },
      {
        "question": "How does the scientific approach of Operations Research help solve complex problems?",
        "marks": 3
      },
      {
        "question": "What are the advantages and limitations of Linear Programming?",
        "marks": 3
      }
    ]
  },
  {
    "semester": "Semester 2",
    "subject": "BASIC MATHEMATICS-I (BCA F1002)",
    "questions": [
      {
        "question": "Successive differentiation",
        "marks": 3
      },
      {
        "question": "Leibnitz Theorem",
        "marks": 3
      },
      {
        "question": "Taylor’s theorem with Lagrange’s forms of remainders",
        "marks": 10
      }
    ]
  }
...
function Semester1() {
  const [showQuestions, setShowQuestions] = useState(() => {
    const savedState = localStorage.getItem('showQuestions');
  ...
  const renderQuestionsByMarks = (questions, marks) => {
    return questions
  ...
  return (
    <div className="App">
      ...
      <div className="semester-name">
        <img
          src="https://fontmeme.com/permalink/240925/76247a096a636766bf876b285c63d322.png"
          alt="futuristic-fonts"
        />
        &nbsp; &nbsp;
        <img
          src="https://fontmeme.com/permalink/241130/537b749c1540dcc198361d07eba7f705.png"
          alt="futuristic-fonts"
        />
        <button
        ...
        >
          <span className="actual-text">&nbsp;{showQuestions ? "Syllabus" : "Question"}&nbsp;</span>
          <span aria-hidden="true" className="hover-text">&nbsp;{showQuestions ? "Syllabus" : "Question"}&nbsp;</span>
        </button>
      ...
      {showQuestions ? (
        <div className="question-paper-section">
          ...
          {Question.map((semesterData, index) => (
            <div key={index} className="semester-question">
              <h3>{semesterData.semester} - {semesterData.subject}</h3>

              <h4>3 Marks Questions</h4>
              <ol>
                {renderQuestionsByMarks(semesterData.questions, 3)}
              </ol>

              <h4>10 Marks Questions</h4>
              <ol>
                {renderQuestionsByMarks(semesterData.questions, 10)}
              </ol>
            </div>
          ))}
        </div>
